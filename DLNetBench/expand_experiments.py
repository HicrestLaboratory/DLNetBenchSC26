...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        ...
        help="The GPU model to emulate compute time (sleep)", choices=["B200", "GB300", "GB200", "H200", "A100", "MI250X", "GH200"]
    )
...
def get_total_runs(strategy: str, gpu_model: str) -> int:
    ...
    target_dict = _STRATEGIES_NUM_RUNS_BX00 if gpu_model in ["GB300", "GB200", "B200"] else _STRATEGIES_NUM_RUNS
